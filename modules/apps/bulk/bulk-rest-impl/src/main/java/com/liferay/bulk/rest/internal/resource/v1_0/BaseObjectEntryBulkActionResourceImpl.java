...
public abstract class BaseObjectEntryBulkActionResourceImpl
	implements EntityModelResource, ObjectEntryBulkActionResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/bulk/v1.0/object-entry-bulk' -d $'{"bulkActionItems": ___, "selectionScope": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ObjectEntryBulkAction"
			)
		}
	)
	@jakarta.ws.rs.Consumes({"application/json", "application/xml"})
	@jakarta.ws.rs.Path("/object-entry-bulk")
	@jakarta.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseObjectEntryBulkActionResourceImpl.class);
