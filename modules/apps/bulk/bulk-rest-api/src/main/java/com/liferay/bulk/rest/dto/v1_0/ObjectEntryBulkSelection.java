 ...
 */
@Generated("")
@GraphQLName("ObjectEntryBulkSelection")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryBulkSelection")
public class ObjectEntryBulkSelection implements Serializable {

	public static ObjectEntryBulkSelection toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectEntryBulkSelection.class, json);
	}

	public static ObjectEntryBulkSelection unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ObjectEntryBulkSelection.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ObjectEntryBulkSelection)) {
			return false;
		}

		ObjectEntryBulkSelection objectEntryBulkSelection =
			(ObjectEntryBulkSelection)object;

		return Objects.equals(toString(), objectEntryBulkSelection.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.ObjectEntryBulkSelection",
		name = "x-class-name"
	)
