...
import com.liferay.bulk.rest.client.serdes.v1_0.BulkActionTaskSerDes;
 ...
 */
@Generated("")
public interface ObjectEntryBulkActionResource {
	...
	public HttpInvoker.HttpResponse postObjectEntryBulkHttpResponse(
			String blueprintExternalReferenceCode, Boolean emptySearch,
			String entryClassNames, String scope, String search,
			String filterString, Pagination pagination, String sortString,
			BulkAction bulkAction)
	...
	public static class Builder {
		...
		public ObjectEntryBulkActionResource build() {
			return new ObjectEntryBulkActionResourceImpl(this);
		}
	...
	public static class ObjectEntryBulkActionResourceImpl
		implements ObjectEntryBulkActionResource {
		...
		private ObjectEntryBulkActionResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ObjectEntryBulkActionResource.class.getName());
