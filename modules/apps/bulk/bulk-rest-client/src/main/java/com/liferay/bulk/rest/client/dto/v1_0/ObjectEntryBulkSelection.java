...
import com.liferay.bulk.rest.client.serdes.v1_0.ObjectEntryBulkSelectionSerDes;
 ...
 */
@Generated("")
public class ObjectEntryBulkSelection implements Cloneable, Serializable {

	public static ObjectEntryBulkSelection toDTO(String json) {
		return ObjectEntryBulkSelectionSerDes.toDTO(json);
	}
	...
	@Override
	public ObjectEntryBulkSelection clone() throws CloneNotSupportedException {
		return (ObjectEntryBulkSelection)super.clone();
	}
	...
	public String toString() {
		return ObjectEntryBulkSelectionSerDes.toJSON(this);
	}
