...
public class ObjectEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newObjectEntry.setPublishDate(RandomTestUtil.nextDate());
		...
		Assert.assertEquals(
			Time.getShortTimestamp(existingObjectEntry.getPublishDate()),
			Time.getShortTimestamp(newObjectEntry.getPublishDate()));
		Assert.assertEquals(
	...
	protected OrderByComparator<ObjectEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"defaultLanguageId", true, "publishDate", true, "expirationDate",
	...
	protected ObjectEntry addObjectEntry() throws Exception {
		...
		objectEntry.setPublishDate(RandomTestUtil.nextDate());
